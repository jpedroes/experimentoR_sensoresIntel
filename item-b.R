...
plot(erromedio(result_regLin2, dados), type="l", col="blue", ylim=c(0,10))
...
result_smo2 = eco_p(0.2, 3)
result_smo3 = eco_p(0.3, 3)
result_smo4 = eco_p(0.4, 3)
result_smo5 = eco_p(0.5, 3)
result_smo6 = eco_p(0.6, 3)
result_smo7 = eco_p(0.7, 3)
result_smo8 = eco_p(0.8, 3)
